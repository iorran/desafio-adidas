...
import com.adidas.db.util.HeaderUtil;
import com.adidas.db.util.ResponseUtil;
...
public class SubscriptionController{
	...
	public ResponseEntity<Long> createSubscription(@RequestBody Subscription subscription) throws URISyntaxException { 
		...
		Long result = subscriptionService.save(subscription);
	...
	public ResponseEntity<List<Subscription>> findAllSubscription() {
		...
		Optional<List<Subscription>> subscriptions = Optional.of(subscriptionService.findAll());
